#ifndef WHIBOX_GCM_WBAES_WBGCM_EE_H
#define WHIBOX_GCM_WBAES_WBGCM_EE_H
...
extern "C" {
    ...
    /******************************************************************
    * CHOW Whitebox-AES with whibox-gcm mode (WBGCM-EE1)
    *****************************************************************/
    struct wbaes_wbgcm_ee_context {
        ...
        uint8_t GBOX_TypeIII[16][2][16][16];
    };
...
#endif //WHIBOX_GCM_WBAES_WBGCM_EE_H
