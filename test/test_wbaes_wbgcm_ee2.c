...
//    aux_WBCRYPTO_wbaes_wbgcm_ee2_encrypt(msg, cipher, &wbaes_ctx);
//    TEST_print_state(cipher, sizeof(cipher));
    ...
    WBCRYPTO_wbaes_wbgcm_ee2_encrypt(wbgcm_enc,msg1024,sizeof(msg1024),cipher1024,sizeof(cipher1024));
    ...
    WBCRYPTO_wbaes_wbgcm_ee2_decrypt(wbgcm_dec,cipher1024,sizeof(cipher1024),plain1024,sizeof(plain1024));
    TEST_print_state(plain1024, sizeof(plain1024));

    WBCRYPTO_wbaes_wbgcm_ee2_free(wbgcm_enc);
    WBCRYPTO_wbaes_wbgcm_ee2_free(wbgcm_dec);
}

int main(){
    test_wbaes_wbgcm_ee2();
}